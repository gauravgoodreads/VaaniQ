...
|----------|---------------:|-----------------------:|--------|
| Hindi | 0 | 0.0000000000 | PENDING |
| Marathi | 0 | 0.0000000000 | PENDING |
| Tamil | 0 | 0.0000000000 | PENDING |

## 2. Number of speakers

Research corpus: **0**. Schema fixture named speakers: **0**.

## 3. Number of clips

Research corpus: **0**. Schema fixture rows: **0**.
Audio files on disk under data trees: **0**.

## 4. Train / validation / test sizes

Research splits: **PENDING** (not written). Fixture split counts: `{'train': 0, 'val': 0, 'test': 0}`.
