...
- **p.1** (Title page): REQ-001
- **p.2** (Executive summary + motivation §2.1): REQ-006, REQ-062, REQ-118
- **p.3** (§2.2 gaps, §3 problem, §4 RQs, §5.1): REQ-002, REQ-003, REQ-004, REQ-005, REQ-007, REQ-008, REQ-009, REQ-010, REQ-011, REQ-012, REQ-013, REQ-014, REQ-015, REQ-016, REQ-040
- **p.4** (Literature §5.2–5.6 start): REQ-045, REQ-116
- **p.5** (§5.6–5.7, §6 objectives, §7.1 start): REQ-017, REQ-018, REQ-019, REQ-020, REQ-021, REQ-022, REQ-023, REQ-024, REQ-025, REQ-026, REQ-027, REQ-028, REQ-029, REQ-030, REQ-118
- **p.6** (§7.1–7.5): REQ-031, REQ-032, REQ-033, REQ-034, REQ-035, REQ-036, REQ-037, REQ-038, REQ-039, REQ-042, REQ-043, REQ-044, REQ-046, REQ-047, REQ-048, REQ-049, REQ-054, REQ-055, REQ-056, REQ-057, REQ-058, REQ-059, REQ-060
- **p.7** (§7.5–7.8 start): REQ-061, REQ-064, REQ-065, REQ-066, REQ-067, REQ-068, REQ-069, REQ-070, REQ-071, REQ-072, REQ-073, REQ-075, REQ-076, REQ-077, REQ-078, REQ-079, REQ-080, REQ-081
- **p.8** (§7.8–7.9, §8): REQ-082, REQ-083, REQ-084, REQ-085, REQ-086, REQ-087, REQ-088, REQ-089, REQ-092, REQ-093, REQ-094, REQ-095, REQ-096, REQ-100
- **p.9** (Figure 1 + tech table): REQ-098, REQ-092, REQ-036, REQ-038, REQ-113
- **p.10** (Latency + §9 expected results + §10 intro): REQ-097, REQ-114, REQ-115, REQ-116, REQ-117, REQ-063
- **p.11** (§10 inventory + §11 compute): REQ-101, REQ-102, REQ-103, REQ-104, REQ-105, REQ-106, REQ-107, REQ-041, REQ-108, REQ-109, REQ-110, REQ-111, REQ-112, REQ-113
- **p.12** (§12 novelty Fig.3): REQ-118, REQ-095
- **p.13** (§12 continued + §13 roles): REQ-125
- **p.14** (§14 out of scope + §15 mockup Fig.2): REQ-120, REQ-090, REQ-091, REQ-087, REQ-088, REQ-089, REQ-004, REQ-139
- **p.15** (§16–18 deliverables, success, limitations): REQ-119, REQ-121, REQ-122, REQ-123, REQ-124, REQ-034
- **p.16** (§19 risks + §20 ethics): REQ-074, REQ-073, REQ-126, REQ-127, REQ-129, REQ-130
- **p.17** (§21 publication + §22 references): REQ-128

## Coverage audit — Topic Approval slides

- **Slide 1** (Title): REQ-001
- **Slide 2** (Agenda): _zero requirements_ — justified (agenda/navigation)
- **Slide 3** (Introduction / threat): REQ-006, REQ-062
- **Slide 4** (Problem + three gaps): REQ-002, REQ-003, REQ-004, REQ-005, REQ-009, REQ-010, REQ-011
- **Slide 5** (Aim + RQs): REQ-012, REQ-013, REQ-014, REQ-015, REQ-016
- **Slide 6** (Objectives O1–O8): REQ-017, REQ-018, REQ-019, REQ-020, REQ-021, REQ-022, REQ-023, REQ-024
- **Slide 7** (Literature themes): REQ-040, REQ-045
- **Slide 8** (Closest works vs VaaniQ): REQ-118
- **Slide 9** (Research gap / novelty): REQ-118, REQ-075
- **Slide 10** (Scope in/out): REQ-119, REQ-120
- **Slide 11** (Feasibility): REQ-034, REQ-037, REQ-108, REQ-112, REQ-064
- **Slide 12** (Dataset inventory): REQ-025, REQ-026, REQ-027, REQ-028, REQ-030, REQ-031, REQ-032, REQ-035
- **Slide 13** (Pipeline stack): REQ-084, REQ-092, REQ-097, REQ-113
- **Slide 14** (Algorithm & evaluation): REQ-036, REQ-038, REQ-042, REQ-043, REQ-044, REQ-046, REQ-048, REQ-049, REQ-054
- **Slide 15** (Expected results): REQ-114, REQ-115, REQ-116, REQ-117
- **Slide 16** (Timeline): REQ-128
- **Slide 17** (Conclusion): REQ-118
- **Slide 18** (References [1–10]): _zero requirements_ — justified (bibliography-only)
- **Slide 19** (References [11–19]): _zero requirements_ — justified (bibliography-only)

## Notes

1. Third language: body text says "one additional Indian language"; Fig.2 mockup names **Tamil**. REQ-004/REQ-132/REQ-139 encode Tamil (`ta`). Logged as OQ-001 if supervisor overrides.
